...
const EmployeeAgreementList = () => {
  ...
  useEffect(() => {
    axios
      ...
      .get("http://localhost:3000/employeeagreement/list")
  ...
  const handleSubmit = () => {
    axios
      .post("http://localhost:3000/employeeagreement/add", newAgreement)
      .then((response) => {
  ...
  const handleEditSubmit = () => {
    axios
      .put(
        `http://localhost:3000/employeeagreement/update/${editAgreement.id}`,
        editAgreement
      )
      .then((response) => {
  ...
  const handleDelete = () => {
    axios
      .delete(
        `http://localhost:3000/employeeagreement/delete/${selectedAgreementId}`
      )
      .then(() => {
        setAgreements((prevAgreements) =>
